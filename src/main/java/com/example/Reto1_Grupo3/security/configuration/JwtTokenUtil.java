package com.example.Reto1_Grupo3.security.configuration;
...
public class JwtTokenUtil {
	...
	public String generateAccessToken(UserDAO userDAO) {
		...
		return Jwts.builder()
				...
				.setSubject(userDAO.getLogin())
				.setIssuer("ADT_DAM")
				.setIssuedAt(new Date())
				.setExpiration(new Date(System.currentTimeMillis() + EXPIRE_DURATION))
				.claim("userId", userDAO.getId()) // podriamos meter datos custom, u objetos custom. 
